...
\author{Manfred Brill, Miriam Lohm"uller, Pascal Pries} % Author(s)
...
%----------------------------------------------------------------------------------------
%
%\newcommand{\leftfoot}{\includegraphics[width=0.08\linewidth]{../../../images/Logos/Curriculum4} \includegraphics[width=0.08\linewidth]{../../../images/Logos/CZS+Logo} \includegraphics[width=0.08\linewidth]{../../../images/Logos/SV_Logo}}
...
\begin{block}{Peerleaders}
    ...
    \begin{figure}
        \includegraphics[width=0.4\linewidth]{\imagePath/peerLeader/Peerleaders_Logo}
    \end{figure}
    ...
    \end{itemize}
        ...
        \vspace{20px}
    \begin{figure}
        \includegraphics[width=0.9\linewidth]{\imagePath/peerLeader/schaubild}
%       \caption{Schaubild}
    \end{figure}
    \vspace{40px}
...
\vspace{24px}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.98\linewidth]{../../../images/Connect/ConnectOberflaeche1}
...
\begin{block}{Digitale Abgabe}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{../../../images/Hochschule/digitaleAbgabe2}
...
\begin{block}{Werkzeuge aus dem Berufsleben}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{../../../images/Hochschule/tools}
...
\begin{block}{Gamification}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.76\linewidth]{../../../images/Hochschule/gamification}
...
\begin{block}{Flipped Classroom}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{../../../images/Misc/youtube2}
%       \caption{YouTube}
        \label{fig:youtube2}
    \end{figure}
\end{block}
